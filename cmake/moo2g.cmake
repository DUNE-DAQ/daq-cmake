...
set(MOO_CMD_2g "moo" CACHE STRING "The 'moo' command")
...
macro(moo_generate)
  cmake_parse_arguments(MC "" "CODEDEP;MODEL;TEMPL;CODEGEN;MPATH;TPATH;GRAFT" "TLAS" ${ARGN})
  ...
  add_custom_command(OUTPUT ${MC_CODEGEN} COMMAND ${MOO_CMD_2g} ${MC_CODEGEN_ARGS} DEPENDS ${MC_CODEDEP})
